...
public class QuestionObject {
     ...
     * @param body
     */
    public QuestionObject(Integer id, String date, String category, String title, String body, String language, String screenshot) {
        super();
        this.id = id;
        this.date = date;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof QuestionObject) == false) {
            return false;
        }
        QuestionObject rhs = ((QuestionObject) other);
